create table address (
    ...
    city_id integer,
    donor_id integer,
    type_address tinyint check (type_address between 0 and 2),
    cep varchar(255),
...
create table donation_item (
    ...
    quantity float(53),
    status_item tinyint check (status_item between 0 and 2),
    primary key (id)
);
...
create table product (
    id integer generated by default as identity,
    product_category tinyint check (product_category between 0 and 3),
    unit_of_measure tinyint check (unit_of_measure between 0 and 3),
    name varchar(255),
    primary key (id)
);
